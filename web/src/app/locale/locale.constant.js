    ...
    .constant('locales',
        {
            'en_US': {
                ...
                "login": {
                    ...
                    "sign-in-title": "Log in to see EasyTech in action.",
                    ...
                    "sign-up-title": "Create your personal account on the EasyTech cloud. It is totally free!",
                    "sign-up": "Sign up",
                ...
                "board": {
                    ...
                    "delete-board-title": "Are you sure you want to delete the board '{{boardName}}'?",
                    "delete-board-text": "Be careful, after the confirmation the board and all related data will become unrecoverable.",
                    "delete-boards-title": "Are you sure you want to delete { count, select, 1 {1 board} other {# boards} }?",
                    "delete-boards-action-title": "Delete { count, select, 1 {1 board} other {# boards} }",
                    "delete-boards-text": "Be careful, after the confirmation all selected boards will be removed and all related data will become unrecoverable.",
                ...
                "script": {
                    ...
                    "script-upload-failed-error": "Failed to upload script to board",
                    "script-upload-success": "Script has been uploaded to board",
                    "please-save-new-script": "Please save the new script before uploading",
                    "please-select-board": "Please select a board",
                    "open-toolbar": "Open script editor toolbar",
                    "close-toolbar": "Close toolbar",
                    "upload-to-board": "Upload to board",
                    ...
                    "confirm-convert-cancel": "Stay in JavaScript",
                },
                "dashboard": {
